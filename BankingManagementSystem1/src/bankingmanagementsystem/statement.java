...
public class statement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please confirm your account number:");
...
try
 ...
 String ACNO=jTextField1.getText();
  ...
  String sql1="select * from BALANCE where ACNO='"+ACNO+"'";
  ResultSet res=stmt.executeQuery(sql1); // TODO add your handling code here:
  if(res.next())
  	      {
                  
		String sql="select BALANCE from BALANCE where ACNO='"+ACNO+"'";
...
dispose();
    new Index() .setVisible(true);     }//GEN-LAST:event_jButton2ActionPerformed
